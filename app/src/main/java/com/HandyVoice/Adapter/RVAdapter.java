package com.HandyVoice.Adapter;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
     ...
     //       container = (LinearLayout) itemView.findViewById(R.id.linear_layout); //
        ...
        public void onClick(View v) {
                ...
                courseClicked=coursesList.get(position).getCourseName();
                Toast.makeText(context, courseClicked, Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(context, CourseOpenerActivity.class);
                intent.putExtra("COURSE_TITLE",courseClicked);
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case R.id.action_add_favourite:
                    Toast.makeText(context, "This option is coming soon"+position, Toast.LENGTH_SHORT).show();

                    return true;
                case R.id.action_play_next:
                    Toast.makeText(context, "This option is coming soon", Toast.LENGTH_SHORT).show();
                    return true;
                default:
            }
            return false;
